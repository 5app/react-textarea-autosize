...
var TextareaAutosize = (function (_React$Component) {
  ...
  _createClass(TextareaAutosize, [{
    ...
    value: function _resizeComponent() {
      ...
      this.setState((0, _calculateNodeHeight2['default'])(_react2['default'].findDOMNode(this), useCacheForDOMMeasurements, this.props.rows || this.props.minRows, this.props.maxRows));
    }
    ...
    key: 'blur',
    value: function blur() {
      _react2['default'].findDOMNode(this).blur();
    }
  }, {
    key: 'value',
    get: function get() {
